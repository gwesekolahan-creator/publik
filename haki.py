...
class Session:
	...
	def generate_ugent(self):
		...
		meki = 'Davik/2.1.0 (Linux; U; Android 6.0.0; EVA-L09 Build/HUAWEIEVA-L09) [FBAN/MessengerLite; FBAV/{str(random.randrange(60,320))}.0.0.{str(random.randrange(4,8))}.{str(random.randrange(60,150))}; FDPN/com.facebook.mlite; FBL C/en_US; FBBV/172917909; FBCR/null; FBMF/vivo; FBBD/vivo; FBDV/vivo V3Max; FBSV/6.0.0: FBCA/armeabi-v7a:armeabi; FBDM/{density-2.0, width= 720, height=1412):1'
		return meki		
